...
/// @dev This contract will hold the tokens of the advisory.
///  Tokens will be locked for a 12 month period
...
contract AdvisoryTokensHolder is Owned {
    ...
    function AdvisoryTokensHolder(address _owner, address _contribution, address _tln) public {
        owner = _owner;
    ...
    function collectTokens() public onlyOwner {
        ...
        assert(tln.transfer(owner, balance));
